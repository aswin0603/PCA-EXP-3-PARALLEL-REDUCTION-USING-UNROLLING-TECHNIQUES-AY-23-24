...
## OUTPUT:
<img width="1618" height="125" alt="image" src="https://github.com/user-attachments/assets/5f3ef4c5-7bdc-4bc1-86a8-b8611bf0969f" />


## RESULT:
Thus the program has been executed by unrolling by 8 and unrolling by 16. It is observed that `Unrolling16` has executed with less elapsed time than `Unrolling8` with blocks 2048, 4096.
